    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                CharSequence message = "I shouldn't go off!";
        ...
        Context context = getApplicationContext();
        CharSequence message = "You received a message!";
        int durration = Toast.LENGTH_LONG;
        Toast toast = Toast.makeText(context, message, durration);
        toast.show();
